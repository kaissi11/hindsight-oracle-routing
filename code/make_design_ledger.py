...
MANIFEST = [
    ...
    ("osrm-v2", "scenario_bucket_v2_osrm_seed_*.json", "Damascus OSRM",
     "v2", "greedy; oracle-8 (v1, v2); rolling-OR; repair; reactive-NN", "primary", "Table 2"),
    ("london-v2", "scenario_bucket_v2_london_seed_*.json", "London OSRM (zero-shot)",
     "v2", "greedy; oracle-8 (v1, v2); rolling-OR; repair", "confirmation", "Table 2, A.2"),
    ("synth-v2", "scenario_bucket_v2_synthetic_seed_*.json", "synthetic Euclidean",
     "v2", "greedy; oracle-8 (v1, v2); rolling-OR; repair", "confirmation", "Table 2"),
    ("n100-v2", "scenario_bucket_v2_n100_seed_*.json", "synthetic Euclidean",
     "v2", "greedy; oracle-8 (v1, v2); rolling-OR; repair", "primary", "Table 2, A.3"),
    ("osrm-s5", "scenario_bucket_v2_osrm_s5_seed_*.json", "Damascus OSRM",
     "v2", "look-8 (online) vs oracle-8, rolling-OR, repair", "primary", "Table 3"),
    ("london-s5", "scenario_bucket_v2_london_s5_seed_*.json", "London OSRM (zero-shot)",
     "v2", "look-8 (online) vs oracle-8, rolling-OR, repair", "confirmation", "Table 3"),
    ...
    ("repair-v1-osrm", "scenario_bucket_repair_osrm_seed_*.json", "Damascus OSRM",
     "v1", "greedy; oracle-8; repair; reactive-NN", "confirmation", "Table 2 (v1 rows)"),
    ...
    ("obs-base", "scenario_bucket_v2_obs_base_seed_*.json", "Damascus OSRM",
     "v2", "look-8 observability: base-matrix mode", "mechanism", "Table 4a, 6.4a"),
    ("obs-mask", "scenario_bucket_v2_obs_mask_seed_*.json", "Damascus OSRM",
     "v2", "look-8 observability: mask-only mode", "mechanism", "Table 4a, 6.4a"),
    ("obs-traffic", "scenario_bucket_v2_obs_traffic_seed_*.json", "Damascus OSRM",
     "v2", "look-8 observability: traffic-only mode", "mechanism", "Table 4a, 6.4a"),
    ("hstress-h4", "scenario_bucket_v2_hstress_h4_seed_*.json", "Damascus OSRM",
     "v2", "look-8; oracle-8; rolling-OR; repair (H=4 h)", "boundary", "6.8"),
    ("hstress-h6", "scenario_bucket_v2_hstress_h6_seed_*.json", "Damascus OSRM",
     "v2", "look-8; oracle-8; rolling-OR; repair (H=6 h)", "boundary", "6.8"),
    ("matched-h8", "matched_information_h8_seed_*.json", "Damascus OSRM",
     "v2", "matched clairvoyant vs online vs frozen-arm oracle (K=8)", "mechanism", "Table 3d, 6.3a"),
    ("matched-h4", "matched_information_h4_seed_*.json", "Damascus OSRM",
     "v2", "matched clairvoyant vs online vs frozen-arm oracle (K=8, H=4 h)", "mechanism", "Table 3d, 6.3a"),
    ("generic-hindsight", "generic_hindsight_repair.json", "Damascus OSRM",
     "v2", "best-of-8 randomized repair restarts (no learning)", "mechanism", "Table 3c"),
    ...
    ("dec-2opt", "scenario_bucket_v2_dec_2opt_seed_*.json", "Damascus OSRM",
     "v2", "look-8 + 2-opt polish (decoder ablation)", "exploratory", "Table 3b"),
    ("dec-msa4", "scenario_bucket_v2_dec_msa4_seed_*.json", "Damascus OSRM",
     "v2", "look-8-MSA(4) scenario scoring (decoder ablation)", "exploratory", "Table 3b"),
    ("cyc-plain", "scenario_bucket_v2_cyc_plain_seed_*.json", "Damascus OSRM",
     "v2 + cycle 0.4", "look-8 (frozen matrix) under cyclic traffic", "exploratory", "6.7"),
    ("cyc-msa4", "scenario_bucket_v2_cyc_msa4_seed_*.json", "Damascus OSRM",
     "v2 + cycle 0.4", "look-8-MSA(4) (cycle-aware scoring)", "exploratory", "6.7"),
